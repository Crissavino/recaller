...
return [
    ...
    'welcome_subtitle' => 'Vamos a configurar tu clinica en solo unos pasos. Esto solo tomara un par de minutos.',
    'feature_1_title' => 'Seguimientos Automaticos',
    'feature_1_desc' => 'Nunca pierdas un paciente. Enviaremos WhatsApp automaticamente cuando pierdas una llamada.',
    'feature_2_title' => 'Conversaciones Inteligentes',
    'feature_2_desc' => 'Gestiona todas las conversaciones con pacientes en un solo lugar.',
    'feature_3_title' => 'Seguimiento de Ingresos',
    'feature_3_desc' => 'Ve cuantos ingresos estas recuperando de llamadas perdidas.',
    ...
    'phone_flow_4' => 'Si no se atiende, enviamos un seguimiento automatico por WhatsApp',
    ...
    'forwarding_title' => 'Configura el Desvio de Llamadas',
    'forwarding_subtitle' => 'Elige el metodo adecuado para el telefono de tu clinica.',
    'forwarding_recommended' => 'Recomendado',
    'forwarding_mobile_title' => 'Telefono Movil',
    'forwarding_mobile_step_1' => 'Abre la app de Telefono',
    'forwarding_mobile_step_2' => 'Ajustes → Llamadas → Desvio de llamadas',
    'forwarding_mobile_step_3' => 'Activa "Cuando no contesto"',
    'forwarding_mobile_step_4' => 'Ingresa tu numero de Recaller',
    'forwarding_mobile_quick_code' => 'Codigo rapido: ',
    'forwarding_landline_title' => 'Telefono Fijo / Centralita',
    'forwarding_landline_step_1' => 'Contacta a tu operador',
    'forwarding_landline_step_2' => 'Solicita desvio "por no contestar"',
    'forwarding_landline_step_3' => 'Indica tu numero de Recaller',
    'forwarding_landline_step_4' => 'Confirma la activacion',
    'forwarding_landline_note' => 'O configura desde el panel PBX (Asterisk, 3CX)',
    'forwarding_voip_title' => 'Sistema VoIP',
    'forwarding_voip_step_1' => 'Accede al dashboard VoIP',
    'forwarding_voip_step_2' => 'Reglas de llamadas → Desvio',
    'forwarding_voip_step_3' => 'Configura "Si no contesto despues de X segundos"',
    'forwarding_voip_step_4' => 'Agrega tu numero de Recaller',
    'forwarding_tip' => '<strong>Recomendamos el desvio "por no contestar"</strong> — asi tu clinica puede atender primero, y Recaller solo maneja las llamadas perdidas.',
    ...
    'next_step_2' => 'Las llamadas perdidas activaran automaticamente seguimientos por WhatsApp y apareceran en tu dashboard',
    ...
    'template_placeholder' => 'Escribe un mensaje amigable que se enviara a quienes llamen...',
    'default_template_name' => 'Seguimiento Llamada Perdida',
    ...
    'test_subtitle' => 'Envia un WhatsApp de prueba para verificar que todo funciona correctamente.',
    'phone_ready' => 'Numero de Telefono Listo',
    'test_phone_number' => 'Tu Numero de Telefono',
    'test_phone_help' => 'Ingresa tu numero de telefono para recibir el mensaje de prueba',
    'message_preview' => 'Vista Previa del Mensaje',
    'send_test' => 'Enviar WhatsApp de Prueba',
    'test_sent' => 'WhatsApp de prueba enviado! Revisa tu telefono.',
    'test_failed' => 'Error al enviar WhatsApp de prueba',
    'no_phone_title' => 'Sin Numero de Telefono Configurado',
